...
void elevation(int starting_angle, int ending_angle, int step) {
  ...
  int i;
  start_dutycycle = starting_angle + 2250;
  end_dutycycle = ending_angle + 2250;
  steps = step * 10;
...
void azimuth(int start, int end, int step) {
  ...
  int start_dutycycle, end_dutycycle, steps;
  int i;
  start_dutycycle = start_dutycycle * 10 + 2250;
  end_dutycycle = end_dutycycle * 10 + 2250;
  steps = step * 10;
...
void setServoPose(int elevation, int azimuth){
  ...
  elevation_dtcycle = elevation * 10 + 2250;
  azimuth_dtcycle = azimuth * 10 + 2250; 

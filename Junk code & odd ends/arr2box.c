...
char* outputInvatory(int list[3], int len, char* dis);
...
int main(){ 
    ...
    char *outputMessage;
     outputMessage = outputInvatory(list, InvatoryLen, outputMessage);    
...
char dest[BUFFER] = "\n------------\n";
char* outputInvatory(int list[3], int InvatoryLen, char* dis){    
